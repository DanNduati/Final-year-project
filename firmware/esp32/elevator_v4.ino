...
void streamCallback(StreamData data)
{
  ...
  if (floor_data_callback < previousFloor) {
      Serial.print("Shuka: ");
      Serial.println(String(abs(floor_data_callback - previousFloor)));
      shuka(abs(floor_data_callback - previousFloor));
      previousFloor = currentFloor;
    }
    else {
      Serial.print("Panda: ");
      Serial.println(String(abs(floor_data_callback - previousFloor)));
      panda(abs(floor_data_callback - previousFloor));
      previousFloor = currentFloor;
    }
